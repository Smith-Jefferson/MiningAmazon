...
class Page{
    ...
    private $config  = array(
        'header' => '<span class="rows">A Total Of %TOTAL_ROW% Record</span>',
        'prev'   => '<<',
        'next'   => '>>',
        'first'  => '1...',
        'last'   => '...%TOTAL_PAGE%',
    ...
    public function show() {
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 2){
            $the_first = "<li><a class='first' href='" . $this->url(1) . "'>" . $this->config['first'] . '</a></li><li><b class="pn-break ">...</b></li>';
        } elseif($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 1){
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            $the_end = '<li><b class="pn-break ">...</b></li><li><a class="end" href="' . $this->url($this->totalPages) . '">' . $this->config['last'] . '</a></li>';
        }
